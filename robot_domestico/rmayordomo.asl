...
+!comprar(supermarket, beer, M) : not ordered(beer)
   <- 	
      ...
      ?nbeersPerTime(NBeer);
	  //.print(Agt);
	   .send(self, achieve, order(beer,NBeer, M));
